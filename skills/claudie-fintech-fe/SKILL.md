---
name: claudie-fintech-fe
description: Use when asked to write or edit frontend code for a fintech product. Prompts for context, explains the approach, and asks for confirmation before writing or editing any file.
---
